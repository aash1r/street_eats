...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  final List<MultiSelectItem<String>> _services = [
    MultiSelectItem('Catering', 'Catering'),
    MultiSelectItem('Wedding Ceremony', 'Wedding Ceremony'),
    MultiSelectItem('Birthdays', 'Birthdays')
  ];
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    }, text: 'Offering Services', items: _services),
                    20.verticalSpace,
                    CustomButton(
                      onTap: () => Get.back(),
                      height: 21.h,
